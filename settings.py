...
SECRET_KEY = 'django-insecure-9ip2x9c4hqu)@k(rwv%0&*af3@ku0^1y_-p2t@=wk89%vlkb$%'
...
LOGIN_REDIRECT_URL = '/service/submit/'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # You can leave this empty if you are only using app-level templates
